...
`CLARA_VE_OWNER_OPTION` · `CLARA_VE_THEME_URI_TOKEN` ·
`CLARA_VE_THEME_RUNTIME_DELEGATION` · `CLARA_VE_NAV_LOCATION` ·
`CLARA_VE_DEFAULT_KEY` · `CLARA_VE_HEADER_KEY` · `CLARA_VE_FOOTER_KEY` ·
`CLARA_VE_ARTICLE_KEY` · `CLARA_VE_404_KEY` ·
`CLARA_VE_PAGE_KEY_META` · `CLARA_VE_PAGE_SLUG_META` ·
`CLARA_VE_PAGE_STATUS_META` · `CLARA_VE_PAGE_THEME_META` ·
`CLARA_VE_PARKED_STATUS` · `CLARA_VE_IMPORT_DIR` ·
`CLARA_VE_IMPORT_DIR_LEGACY` · `CLARA_VE_SPECIMEN_START` ·
`CLARA_VE_SPECIMEN_END`
