...
Producing the content bundle in the first place is the converter's job; this
plugin reads bundles rather than writing them. The one exception is the backup
the **Parked content** screen offers before you delete a theme that has been
put away.
